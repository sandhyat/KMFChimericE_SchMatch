...
n_p = 2  # number of permutations
n_t = 1  # number of data partitioning trials
...
# list_of_total_Features_in_large_database = [15,20,25,30,35,40,45,50]
num_feat_sq_trans = 0

# data details
outcome = "Y"
dataset_number =  10  #  5 for complex data dependencies
frac_renamed = 0.5
...
if num_xtra_feat_inX1 != 0:
    plt.savefig(saving_dir + "/Not_All_matchesASym_Chim_Syn_" + str(dataset_number) + "_varyingData_num_total_fea_inX2_" + str(
    ...
    plt.savefig(
        saving_dir + "/All_matchesASym_Chim_Syn_" + str(dataset_number) + "_varyingData_num_total_fea_inX2_" + str(
