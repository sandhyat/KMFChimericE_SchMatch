...
def Simple_maximum_sim_viaCorrelation(df_train_preproc, df_rename_preproc,index_for_mapping_orig_to_rename,
    ...
    del df_rename_preproc
    # exit()
    return MisF_X1_te_non_tran, MisF_X2_te_non_tran, temp_inf_x1, temp_inf_x2, final_additional_mapped, final_additional_mapped_corr_match
...
def Train_cross_AE(df_train_preproc, df_rename_preproc, index_for_mapping_orig_to_rename, index_for_mapping_rename_to_orig, reordered_column_names_orig, reordered_column_names_r, mapped_features,mapped_features_updated_orig, mapped_features_updated_r, Cor_from_df,  Df_holdout_orig, DF_holdout_r,sq_transf_features,filename_for_saving_tran_quality,normalizing_values_orig,normalizing_values_r):
    ...
    del df_rename_preproc
    # exit()
    return MisF_X1_te_non_tran, MisF_X2_te_non_tran, temp_inf_x1, temp_inf_x2
...
def main(dataset_no_sample):
    ...
    return AVG_MISMATCHES_X1_tr, AVG_MISMATCHES_X2_tr, np.average(AVG_MISMATCHES_X1_tr, axis=1), np.average(AVG_MISMATCHES_X2_tr, axis = 1), Frac_mismatches_across_trial_perm_X1_tr, Frac_mismatches_across_trial_perm_X2_tr, \
           AVG_MISMATCHES_X1_tr_sim_Cor, AVG_MISMATCHES_X2_tr_sim_Cor, np.average(AVG_MISMATCHES_X1_tr_sim_Cor, axis=1), np.average(AVG_MISMATCHES_X2_tr_sim_Cor, axis = 1), Frac_mismatches_across_trial_perm_X1_tr_sim_Cor, Frac_mismatches_across_trial_perm_X2_tr_sim_Cor,\
           AVG_MISMATCHES_X1_tr_Kang, np.average(AVG_MISMATCHES_X1_tr_Kang,axis=1), Frac_mismatches_across_trial_perm_X1_tr_Kang, AVG_MISMATCHES_X1_tr_RG, AVG_MISMATCHES_X2_tr_RG, np.average(AVG_MISMATCHES_X1_tr_RG, axis=1), np.average(AVG_MISMATCHES_X2_tr_RG, axis = 1), Frac_mismatches_across_trial_perm_X1_tr_RG, Frac_mismatches_across_trial_perm_X2_tr_RG
