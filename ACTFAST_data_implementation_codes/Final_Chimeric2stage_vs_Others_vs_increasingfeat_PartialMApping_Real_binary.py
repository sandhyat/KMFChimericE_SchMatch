...
file_name_violin = saving_dir + "/" + "F1_For_violin_Mismatch_metric_L_" + str(hidden_dim) + "_Real_data_orthoStatus_" + str(orthogonalization_type) + "_BNStatus_" + str(batchnorm) + ".txt"
...
plt.legend()
plt.savefig(saving_dir + "/F1_Not_All_matchesASym_Chimeric_Real_data_varyingData_num_total_fea_inX2_" + str(
