...
parser.add_argument("--mpfeatures", default=5, type=int)  # number of mapped_features
parser.add_argument("--large_database", default=35, type= int)  # number of features in the larger databaseparser.add_argument("--block_stand_comb", default=0, type=int)  # can set the type as bool too but for now int it is
...
# list_of_total_Features_in_large_database = [30,35]
# list_of_total_Features_in_large_database = [12,14, 16,18, 20]  # for dataset 2
# list_of_total_Features_in_large_database = [25,30,35,40,45] # for dataset 5
# list_of_total_Features_in_large_database = [25,30,35,40,45,50,55] # for Nomao
list_of_total_Features_in_large_database = [35,40,45,50,55] # for Nomao & superconductor partial map
num_feat_sq_trans = 0
...
num_xtra_feat_inX1 = 5  # 0 in onto case, 5 in partial mapping case
...
if datatype == 'b' :
    saving_dir = output_dir + 'Partial_Comparison_'+str(datetime.date.today()) +  "/#ofhidden_layers_" + str(
...
# AVG_over_Dataset_samples_X1_tr_RG = np.zeros((len(list_of_total_Features_in_large_database), num_of_dataset_samples))
# AVG_over_Dataset_samples_X2_tr_RG = np.zeros((len(list_of_total_Features_in_large_database), num_of_dataset_samples))
#
...
f.write("\n \n List of total features in large database when small database has {0} features \n ".format(list_of_total_Features_in_large_database[0]))
...
f.write("\n \n List of features in larger database \n ")
f.write("{0}".format(list_of_total_Features_in_large_database))
...
Mean_over_trials_mismatches_X1_tr_RG = np.zeros(len(list_of_total_Features_in_large_database))
SD_over_trials_mismatches_X1_tr_RG = np.zeros(len(list_of_total_Features_in_large_database))
Mean_over_trials_mismatches_X2_tr_RG = np.zeros(len(list_of_total_Features_in_large_database))
SD_over_trials_mismatches_X2_tr_RG = np.zeros(len(list_of_total_Features_in_large_database))
...
#     len(list_of_total_Features_in_large_database)) + "_Num_feat_sq_"+str(num_feat_sq_trans) +str(datatype)+".pdf", bbox='tight')
# plt.savefig(saving_dir + "/Comp_Twostage_vsothers_X2_tr_Syn_" + str(dataset_number) + "_varyingData_num_Mapped_fea_" + str(
#     len(list_of_total_Features_in_large_database)) + "_Num_feat_sq_"+str(num_feat_sq_trans) +str(datatype)+".png", bbox='tight')
# plt.close()