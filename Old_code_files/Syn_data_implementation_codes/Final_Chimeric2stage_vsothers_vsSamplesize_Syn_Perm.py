        ...
        for trial in range(n_t):
            ...
            for partition in range(n_p):
                ...
                Mistakes_X1_tr, Mistakes_X2_tr, match_details_x1, match_details_x2, F1_x1, F1_x2 = Train_cross_AE(
                    ...
                    filename_for_saving_tran_quality, normalizing_values_orig, normalizing_values_r, P_x1_updated[len(mapped_features):-1,len(mapped_features):-1])
...
plt.ylabel("F1 score across different dataset sample")
plt.title("Dataset no. " + str(dataset_number) + " Results from X1 cross correlation matrix ")
plt.legend()
plt.savefig(saving_dir + "/F1_Comp_ChimVsothers_X1_tr_Syn_" + str(dataset_number) + "_varying_sample_size_" + str(
...
plt.legend()
plt.savefig(saving_dir + "/F1_Comp_ChimVsothers_X2_tr_Syn_" + str(dataset_number) + "_varying_sample_size_" + str(
    len(list_of_number_samples)) + ".pdf", bbox='tight')
plt.savefig(saving_dir + "/F1_Comp_ChimVsothers_X2_tr_Syn_" + str(dataset_number) + "_varying_sample_size_" + str(
    len(list_of_number_samples)) + ".png", bbox='tight')
plt.close()
