    ...
    for mpfeatures in list_of_number_mapped_variables:
        ...
        for trial in range(n_t):
            ...
            for partition in range(n_p):
                ...
                Mistakes_X1_tr_RG, Mistakes_X2_tr_RG, F1_x1_RG, F1_x2_RG = RadialGAN(df_train_preproc.copy(), df_rename_preproc.copy(), index_for_mapping_orig_to_rename, index_for_mapping_rename_to_orig, df_train_preproc.columns, reordered_column_names_r, mapped_features ,partition,Cor_from_df,Df_holdout_orig,
...
plt.savefig(saving_dir + "/F1_Comp_ChimVsRG_X2_tr_Real_data_varyingData_num_Mapped_fea_" + str(
    len(list_of_number_mapped_variables)) + ".pdf", bbox='tight')
plt.savefig(saving_dir + "/F1_ Comp_ChimVsRG_X2_tr_Real_data_varyingData_num_Mapped_fea_" + str(
    len(list_of_number_mapped_variables)) + ".png", bbox='tight')
plt.close()
