...
plt.ylabel("Fraction of mistakes across different trials")
plt.title("ACTFAST data ")
plt.legend()
plt.savefig(saving_dir + "/Comp_ChimVsRG_X1_tr_Real_data_varying_sample_size_" + str(
...
plt.title(" ACTFAST data ")
plt.legend()
plt.savefig(saving_dir + "/Comp_Chim_X2_tr_Real_data_varying_sample_size_" + str(
    len(list_of_number_samples)) + ".pdf", bbox='tight')
plt.savefig(saving_dir + "/Comp_Chim_X2_tr_Real_data__varying_sample_size_" + str(
    len(list_of_number_samples)) + ".png", bbox='tight')
plt.close()